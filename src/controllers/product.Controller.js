...
const handleAddProductDetails = async (req, res) => {
  try {
    let data = await addProductDetailsService(req, res);
...
const handleRestoreProduct = async (req, res) => {
  try {
    let data = await restoreProductService(req, res);
